...
class Lang():
    ...
    def load_langs(self, language: str = "en"):
        ...
        # English as a backup for when the main lang does not contain the str you're looking for.
        self.english_lang = JsonFile(Paths.lang_packs + "en.json").get_file()
        ...
        logging.info(self.info("LOADED_LANG", self.lang.get(
            "formal_name", f"{language}.json")))
