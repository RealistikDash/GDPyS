...
class PrivilegeHelper():
    ...
    async def cache_privs(self) -> None:
        ...
        async with myconn.conn.cursor() as mycursor:
            await mycursor.execute("SELECT id, name, privileges, colour FROM privilegegroups") # A server shouldn't have any more than like 10 groups
