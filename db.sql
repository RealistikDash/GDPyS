...
--
-- Host: localhost:3306
-- Generation Time: Oct 03, 2020 at 08:48 PM
...
--
-- Table structure for table `commentbans`
--
...
CREATE TABLE `levels` (
  ...
  `hostname` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'GDPyS',
...
--
ALTER TABLE `accounts`
  MODIFY `accountID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
--
...
--
ALTER TABLE `dailyfeatures`
  MODIFY `feaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `levels`
  MODIFY `levelID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT for table `levelscores`
--
ALTER TABLE `levelscores`
  MODIFY `scoreID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
--
